          ...
          <div className="min-w-7xl   mx-auto border-b border-gray-50 bg-white px-2 sm:px-6 lg:px-8">
            <div className="relative   mx-0 flex h-16 items-center justify-between md:mx-20">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button className="rounded-md border border-violet-100 px-3 py-2 text-sm font-medium text-violet-400 hover:bg-violet-500 hover:text-white  hover:shadow-lg" onClick={()=> signIn()}>
                  Register
                </button>
              </div>
            </div>
